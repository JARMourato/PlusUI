...
// MARK: - Warning: this view uses internal swiftUI API
...
public struct PagingView<Views: View>: View {
    ...
    public init(config: Config = Config(), page: Binding<PageIndex>? = nil, @ViewBuilder _ content: () -> Views) {
    ...
    public init(direction: _PagingViewConfig.Direction, page: Binding<PageIndex>? = nil, @ViewBuilder _ content: () -> Views) {
        tree = _VariadicView.Tree(
